...
El \textit{frontend} se comunicará con el \textit{backend} usando tanto \textit{manual triggering}, realizando las consultas a través de una petición explícita del usuario, como \textit{long pooling}, lanzando consultas automáticas al \textit{backend} en intervalos largos (de aprox. 40s). El formato de las comunicaciónes será mediante peticiones de tipo REST.
