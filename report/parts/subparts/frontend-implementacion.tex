...
\begin{itemize}
    ...
    \item Tiene listas de todos los elementos disponible (ordenados por proximidad donde aplicable)
...
Nuestros requisitos funcionales para el frontend forman un ejemplo destacado de un \emph{Single Page Application} (aplicación de una sola página), porque por diseño es una sola página con comportamiento complejo. La implementación también beneficio del gran foco a componentes individuales.
...
La gran ventaja de usar Mapbox sobre otro proveedor de mapas es que el uso se mide por las cargas de página y no baldosas solicitado (qué pase siempre que hay movimiento). Ya que solo usamos un mapa, pero movemos mucho,
